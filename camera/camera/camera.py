...
class Camera(Node):
    ...
    def __init__(self, framerate):
        ...
        self.detector = ScaleDetector(delta1=20, delta2=5, n=20, phi1=0.02, phi2=0.005, sigma1=0.01, sigma2=0.001, m=20, count=20, accuracy=0.5)
        self.shape = (1000, 200)
    ...
    def main(self):
        ...
        corners[2] += 9*(corners[2]-corners[3])//2
